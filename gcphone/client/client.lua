...
--====================================================================================
--  			if IsControlJustReleased(0, Keys['F22'])
--( IsControlJustReleased( 0, 288 ) or IsDisabledControlJustReleased( 0, 288 ) )
--====================================================================================
Citizen.CreateThread(function()
  
  while true do
    Citizen.Wait(0)
	if ( IsControlJustReleased( 0, 288 ) or IsDisabledControlJustReleased( 0, 288 ) ) and GetLastInputMethod( 2 ) then
      TooglePhone()
    end
